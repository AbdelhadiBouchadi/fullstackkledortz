      ...
      {projects.map((project, index) => (
        ...
        >
          ...
          >
            ...
            <div className="absolute top-0 left-0 w-full h-full justify-center items-center flex text-white text-4xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 ease-in-out uppercase text-center ">
              {project.title}
            </div>
          </motion.div>
        </Parallax>
